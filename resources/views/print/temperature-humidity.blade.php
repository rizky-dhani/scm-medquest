...
<head>
    ...
    <style>
        ...
        .time-column, .temp-column { width: 35px; }
        .rh-column { width: 30px; }
    </style>
</head>
                        ...
                        <div class="row header-container">
                            ...
                            <div class="col-7 d-flex flex-column">
                                ...
                                <div class="row align-items-center h-50 border-start border-end border-black">
                                    <h5 class="fw-bolder text-uppercase text-center mb-0" style="width: 100%;">Temperature And Humidity Monitoring</h5>
                                </div>
                            </div>
                            ...
                            <div class="col-7 pe-0 border border-black border-end-0 py-1">
                                <div class="row">
                                    <div class="col-3">
                                        ...
                                        <p class="mb-0" style="font-size: 12px;">Observed Temperature *</p>
                                    </div>
                                    <div class="col-9">
