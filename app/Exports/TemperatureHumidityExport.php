...
class TemperatureHumidityExport implements WithMultipleSheets
{
    ...
    public function __construct(Collection $records, ?string $title = null)
    {
        ...
        $this->groupedRecords = $records->groupBy('room_id');
    }
